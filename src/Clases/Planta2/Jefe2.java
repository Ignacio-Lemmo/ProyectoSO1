...
public class Jefe2 extends Thread{
    ...
    public void run(){
        while(true){
            ...
            Thread.sleep((Main.tiempo/24)*(20/60));
            //Cambiar el estado del Jefe a Revisando.
            Main.jefeEstado = 2;
            Planta2.jefe2.setText("Revisando");
            
            Thread.sleep((Main.tiempo/24)*(20/60));
            //Cambiar el estado del Jefe a Durmiendo.
            Main.jefeEstado = 3;
            Planta2.jefe2.setText("Durmiendo");
            
            Thread.sleep(Main.tiempo - ((Main.tiempo/24)*6)+(Main.tiempo/24)*(20/60)+(Main.tiempo/24)*(20/60));
            }catch (Exception e) {
